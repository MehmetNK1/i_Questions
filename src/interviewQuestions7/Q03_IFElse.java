...
public class Q03_IFElse {
        ...
        ORNEK:
            ...
            3'ün katı olan sayılar için 1'den 30'a kadar olan sayıları yazdıran bir yöntem yazın,
         sayı yerine Kaya yazdırın ve 5'in katı olan sayılar için sayı yerine Yıldız yazdırın.
         Hem 3 hem de 5'in katı olan sayılar için sayı yerine RockStar yazdırın.
         ÖRNEK:
             GİRDİ : 1 2 3 4 ..... 30
             ÇIKTI : 1 2 Rock 4 Star Rock 7 8 Rock Star 11 Rock 13 14 RockStar...
		 */
